...
<section class="border-b border-line-soft bg-gradient-to-b from-brand-50/70 to-white">
    <div class="container-page py-20 lg:py-24">
        ...
        <h1 class="section-title mt-4 max-w-3xl">공개된 데이터를, 같은 기준으로</h1>
...
<section class="container-page py-20">
    <h2 class="text-[22px] font-extrabold text-ink-900">수집하는 데이터</h2>
    ...
    <div class="mt-16 rounded-2xl border border-line bg-surface-muted p-8">
