...
<section class="border-b border-line-soft bg-gradient-to-b from-brand-50/70 to-white">
    <div class="container-page py-20 text-center lg:py-24">
        <p class="eyebrow">Pricing</p>
        <h1 class="section-title mt-4">필요한 만큼만 쓰세요</h1>
        <p class="mx-auto mt-5 max-w-xl text-[16px] leading-relaxed text-ink-500">
...
<section class="container-page py-20">
    <div class="grid gap-6 lg:grid-cols-3">
        @foreach ([
            ...
            <div class="card flex flex-col p-8 {{ $featured ? 'border-brand-500 ring-1 ring-brand-500/20' : '' }}">
                @if ($featured)
